                    ...
                    items={[
                        {
                            ...
                            description:
                                "Name of patient, caregiver, doctor, or health coach; birth date/age; gender.",
                        },
                        {
                            title: "Contact Details: ",
                            description:
                                "Address (including country/pin code), phone/mobile number, and email address.",
                        },
                        {
                            title: "Health Information: ",
                            description:
                                "Physical, physiological, and mental health conditions; medical records, history, and reports.",
                        },
                        {
                            title: "Account & Finance: ",
                            description:
                                "Valid financial information for purchases, Login ID, and password.",
                        },
                        {
                            title: "Technical & Usage Data: ",
                            description:
                                "IP address, browser type/language, referring URL, files accessed, errors, time zone, operating system, and log files.",
                        },
                        {
                            title: "Interaction Records: ",
                            description:
                                "Details of interactions with Nivaan representatives and usage patterns.",
                        },
                        {
                            title: "Other: ",
                            description:
                    ...
                    items={[
                        {
                            title: "Operations: ",
                            description:
                                "To operate and improve the platform, build your profile, and provide effective services.",
                        },
                        {
                            title: "Research: ",
                            description:
                                "To perform studies, analysis, research, and aggregate non-personally identifiable data.",
                        },
                        {
                            title: "Communications: ",
                            description:
                                "To contact you via phone, SMS, WhatsApp, or email for appointments, issues, or reminders.",
                        },
                        {
                            title: "Marketing: ",
                            description:
                                "To send promotional materials and customize advertising based on preferences.",
                        },
                        {
                            title: "Legal & Corporate: ",
                            description:
                                "To respond to legal requests, investigate fraud, or transfer data during mergers or acquisitions.",
                        },
                    ]}
                />
                <PolicySection
                    ...
                    items={[
                        {
                            ...
                            description:
                                "You authorize sharing of data across borders with third parties, affiliates, agents, or banks.",
                        },
                        {
                            title: "Jurisdiction Acknowledgment: ",
                            description:
                                "Some countries may have less stringent data protection laws.",
                        },
                        {
                            title: "Contractual Protections: ",
                            description:
                                "Nivaan will impose contractual obligations to ensure adherence to this policy.",
                        },
                    ]}
                />
                <PolicySection
                    ...
                    items={[
                        {
                            ...
                            description:
                                "Role-based access, password protection, and encryption are used.",
                        },
                        {
                            title: "Authorized Access: ",
                            description:
                                "Access is limited to employees, agents, and partners on a need-to-know basis.",
                        },
                        {
                            title: "Retention: ",
                            description:
                                "Data is stored for at least three years or as required by law.",
                        },
                    ]}
                />
                <PolicySection
                    ...
                    items={[
                        {
                            title: "Cookies: ",
                            description:
                                "You may block or erase cookies, which may affect certain features.",
                        },
                        {
                    ...
                    items={[
                        {
                            ...
                            description:
                                "Updates will be communicated and consent will be required upon your next visit.",
                        },
                        {
                            title: "Compliance: ",
                            description:
                                "You may not use services if this policy violates your local laws.",
                        },
                        {
                            title: "Grievances: ",
                            description:
                                "Contact care@nivaancare.com or Nikita Dhadwal at nikita.dhadwal@nivaancare.com.",
                        },
                    ]}
                />
            </div>
