...
import PatientReviewCardCarousel_new from "@/components/PatientReviewCardCarousel_new";

const WhatPatientSayAboutUsPhysio = ({
  patientReviewData,
  ...
  const isMigraine = pathName === "/next/migraine"||pathName==="/next/jaipur/migraine"||pathName==="/next/lucknow/migraine"
  ...
  return (
    ...
    >
      ...
      {<PatientReviewCardCarousel_new reviews={patientReviewData} />}
    </section>
  );
};

export default WhatPatientSayAboutUsPhysio;
