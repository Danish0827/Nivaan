...
const PlantarFasciitisJaipur = () => {
  ...
  return (
    <div>
      ...
      <Consultingdoctor doctorData={ConsultdoctorJaipur} doctorDataMob={ConsultdoctorJaipur} isForm2={false} formLocation={"Plantar-Fasciitis-our-care-experts"}/>
      <TreatmentAtNivaan
...
export default PlantarFasciitisJaipur;
