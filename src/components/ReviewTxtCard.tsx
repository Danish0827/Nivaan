  ...
  return (
    <div className="bg-[#ECF8FF] py-3 px-6 md:p-6 w-[18rem] md:w-[22.885rem] md:h-[20.242rem] rounded-2xl">
        <div className="flex flex-row justify-between items-baseline">
            ...
            <Image src={googleIcon} alt="googleIcon" width={36.78} height={37.15} className="hidden md:block" />
            <Image src={googleIcon} alt="googleIcon" width={20.8} height={23.43} className="block md:hidden" />
        </div>
        <Image src={fourStar} alt="stars icon" className="mb-2 hidden md:block"  />
        <Image src={fourStar} alt="stars icon" className="mb-2 block md:hidden w-[4.9rem] h-[0.85rem]"  />
