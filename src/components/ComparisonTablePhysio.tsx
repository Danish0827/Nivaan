...
import { PhysiotherapyTableData } from '@/app/api/data';
...
const ComparisonTableResurfacing: React.FC<ComparisonTableProps> = ({ data}) => {
  const tableData = data || (PhysiotherapyTableData);
      ...
      <table className="text-left table-auto">
        <thead>
          <tr className={`${rubikBold.className} text-[10px] md:text-[25px] md:leading-[29.63px]`}>
            ...
            <th className="py-4 px-8 bg-[#EAF1FB] text-[#2F438F] text-center rounded-t-[0.625rem]">Nivaan Superspecialist-Guided Physiotherapy</th>
            <th className="p-4 text-center">Regular Physiotherapy</th>
          </tr>
        </thead>
        <tbody>
