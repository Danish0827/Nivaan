            ...
            <div className="max-w-[1500px] mx-auto px-6 xl:px-10 2xl:px-0 relative text-center">
                ...
                <div className="text-center mt-10 fade-in-up">
                    <Link
                        ...
                        className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-4 py-3 2xl:px-7 2xl:py-4 rounded-full font-semibold shadow-md hover:scale-105 duration-500 cursor-pointer"
                    >
...
function JourneyCard({
    ...
    return (
        ...
        >
            ...
            <span
                className={`hidden lg:block absolute left-[370px] z-20 top-[287px] h-[48%] border-blue-400 rotate-90 dot-move ${
                    isLast ? "border-l-0" : "border-l-4"
                }`}
                style={{
           ...
           <span
            ...
            <h3 style={{ animationDelay: `${index * 0.2}s` }} className="font-semibold -mt-5 text-2xl text-gray-800 line-clamp-2 fade-in-up">
                {item.title}
            </h3>

            <p style={{ animationDelay: `${index * 0.2}s` }} className="text-gray-600 text-base mt-2 leading-relaxed font-light pb-5 fade-in-up">
                {item.info}
            </p>
        </div>
    );
