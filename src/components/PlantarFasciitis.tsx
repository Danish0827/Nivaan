  ...
  return (
    <div>
      ...
      <ThreeColumnHeroBanner
        ...
        heading="Best Plantar Fasciitis Treatment in Delhi NCR"
      ...
      />
      <OurCareExpertsNcrs Heading="Our Care Experts" DoctorData={OurCareExpertsNcr}  isForm2={false} formLocation={"Plantar-Fasciitis-our-care-experts"} />
      <TreatmentAtNivaan
