...
import Form_Consultation from "../Form_Consultation";
...
const HeroSectionRFALPMumbai = ({ imageSrc, form, heading, subHeading, achievementPoints, showFormHeader, formLocation, isTwoByTwoHeaderMetric,sub_heading }: PropTypes) => {
    return (
...
export default HeroSectionRFALPMumbai;