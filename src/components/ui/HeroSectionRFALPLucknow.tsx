...
const HeroSectionRFALPLucknow = ({ imageSrc, form, heading, subHeading, achievementPoints, showFormHeader, formLocation, isTwoByTwoHeaderMetric,sub_heading,sub_heading2 }: PropTypes) => {
    return (
...
export default HeroSectionRFALPLucknow;