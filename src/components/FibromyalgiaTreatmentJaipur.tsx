...
const FibromyalgiaTreatmentJaipur = () => {
  ...
  return (
    <div>
      ...
      <Consultingdoctor doctorData={ConsultdoctorJaipur} doctorDataMob={ConsultdoctorJaipur} isForm2={false} formLocation={"Fibromyalgia-Treatment-our-care-experts"}/>
      ...
      <WhatPatientSayAboutUs
        ...
        pageRoute="/jaipur/fibromyalgia-treatment"
      />
...
export default FibromyalgiaTreatmentJaipur;
