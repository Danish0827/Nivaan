...
const ImageOverlaySlideComponent2 = ({overlaySlideData}: {overlaySlideData: overlaySlideDataType}) => {
  return (
    <div className="relative overflow-hidden w-[21rem] h-[405px]">
      {/* Image */}
      <div className="relative group">
        ...
        <div className="rounded-xl absolute inset-0 bg-[#2985BBE5] text-white transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out flex flex-col items-start">
          <h3 className={`${montserratSemiBold.className} text-sm py-2 px-6 md:px-10`}>{overlaySlideData.title}</h3>
...
export default ImageOverlaySlideComponent2;
