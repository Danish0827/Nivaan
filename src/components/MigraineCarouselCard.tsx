...
const WhatIsCarouselCard: React.FC<WhatIsCarouselCardProps> = ({ data, expanded, toggleExpanded }) => {
    ...
    return (
        <div id='div1' className={`p-6 border-[0.5px] border-[#2F438F] md:border md:border-[#E5E7EB] rounded-md shadow-lg w-full md:w-[377px] md:bg-[#EAF1FB] relative ${ expanded ? `md:h-[42rem]` : 'h-[310px] md:h-[466.5px]'}`}>
