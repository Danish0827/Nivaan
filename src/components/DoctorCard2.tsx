  ...
  return (
    <Card className="relative px-0 mb-10 md:text-center lg:pb-6 w-60 md:w-[23.75rem] text-[#1E1E1E] border-[#BEE4F7]">
      <CardHeader className="relative">
        <Image className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[89px] h-[89px] md:w-[115px] md:h-[115px]" src={doc.img} alt="doctor img" />
      </CardHeader>
      <CardContent className="md:w-full mt-0 md:mt-6 px-0 text-center text-[#1E1E1E]">
        ...
        <Image className="mx-auto mt-2" src={MedicalIcon} alt="MedicalIcon" />
